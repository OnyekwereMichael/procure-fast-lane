      ...
      <div className="container-custom">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={index} className="relative group">
                <div className="flex items-start space-x-8 pb-16 max-sm:pb-2">
                  {/* Step Number & Icon */}
                  <div className="flex-shrink-0 relative">
                    <div className="w-20 h-20 max-sm:w-14 max-sm:h-14 rounded-2xl bg-gradient-primary flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-elegant">
                      <span className="text-2xl font-bold text-white">{step.number}</span>
                    </div>
                    <div className="mt-6 w-16 h-16 max-sm:w-14 max-sm:h-14 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-elegant">
                      <Icon className="h-8 w-8 max-sm:w-6 max-sm:h-6 text-primary" />
                    </div>
                  ...
                  <div className="flex-1 pt-6 bg-card border border-border rounded-2xl p-8 shadow-lg group-hover:shadow-xl transition-elegant">
                    ...
                    <p className="text-lg text-muted-foreground mb-4 leading-relaxed font-medium max-sm:text-base">
                      {step.description}
                    </p>
                    <p className="text-muted-foreground/80 leading-relaxed max-sm:text-base">
                      {step.detail}
                    </p>
                  </div>
                </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center px-8 py-4 bg-accent/10 rounded-2xl border border-accent/20">
            ...
            <span className="text-accent font-bold text-lg max-sm:text-base">
