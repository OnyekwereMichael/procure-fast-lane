      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-20">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-card border border-border rounded-xl p-8  hover:shadow-xl transition-elegant">
              <div className="mb-6">
                ...
                <p className="text-foreground leading-relaxed text-md font-medium mb-6">
                  "{testimonial.quote}"
                </p>
              </div>
              ...
              <div className="border-t border-border pt-6">
                ...
                <div className="bg-accent/10 rounded-xl p-4 flex items-center justify-between">
                  <div className="text-center">
                    <div className="text-2xl max-sm:text-xl font-bold text-accent">{testimonial.savings}</div>
                    <div className="text-muted-foreground font-medium text-[15px]">Cost Savings</div>
                  </div>
                  <div className="text-center">
                    <div className="text-[17px]  font-semibold text-foreground">{testimonial.timeframe}</div>
                    <div className="text-muted-foreground text-[15px] ">Achievement</div>
                  </div>
                </div>
              </div>
            </div>
